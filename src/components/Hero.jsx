        ...
        <div className=" flex h-full flex-col   justify-center ">
          <h1 className="  max-w-4xl text-left font-display text-5xl font-medium tracking-tight text-slate-200 sm:text-7xl">
            <span className="relative whitespace-nowrap  text-green-400">
              ...
              <span className="relative">ReadyMind AI:</span>
            </span>{' '}
            Revolucionando la Gestión de Datos con Inteligencia Artificial
          </h1>
          <p className=" mt-6 max-w-2xl  text-left text-lg tracking-tight text-white">
            En ReadyMind AI, elevamos la gestión de datos con OCR avanzado y
            seguridad Azure. Convierte imágenes en texto analizable y mejora tus
